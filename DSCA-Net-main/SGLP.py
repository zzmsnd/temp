...
unlabeled_train_gt_2D = split_dataset_SGLP(DataPath, GTPath, labeled_train_gt_2D, test_gt_2D, unlabeled_num=500, num_superpixel=420)
io.savemat('./Data/Indian_pines/10label/Indian_pines_10label_train9.mat', {'data': labeled_train_gt_2D})  #保存mat文件
io.savemat('./Data/Indian_pines/10label/Indian_pines_10label_unlabeled_train9.mat', {'data': unlabeled_train_gt_2D})  #保存mat文件
io.savemat('./Data/Indian_pines/10label/Indian_pines_10label_test9.mat', {'data': test_gt_2D})
##TSNE
