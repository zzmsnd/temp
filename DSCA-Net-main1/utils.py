...
from model import Network, Supervisednetwork , TRNetwork,Transformer
...
def set_model(args):
    ...
    if args.model == 'Network':
        ...
        return model1
    if args.model == 'TRNetwork':
        model1 = Transformer(args.bands, args.num_classes, args.feature_dim)
        return model1
